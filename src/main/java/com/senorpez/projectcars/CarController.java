...
class CarController {
    ...
    Resource cars(
        ...
        return assembler.toResource(Application.CARS.stream()
...
//        car.removeLinks();
//        car.add(linkTo(methodOn(CarController.class).cars(car.getId())).withSelfRel());
//        return car;
//    }
//
//    static Car addLink(Car car, Integer eventId) {
//        car.removeLinks();
//        car.add(linkTo(methodOn(CarController.class).eventCars(eventId, car.getId())).withSelfRel());
//        car.add(linkTo(methodOn(CarController.class).cars(car.getId())).withRel("car"));
//        return car;
//    }
}

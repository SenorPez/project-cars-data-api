...
//        round.removeLinks();
//        round.add(linkTo(methodOn(RoundController.class).rounds(eventId, round.getId())).withSelfRel());
//        round.add(linkTo(methodOn(EventController.class).events(eventId)).withRel("event"));
//        round.add(linkTo(methodOn(TrackController.class).tracks(round.getTrack().getId())).withRel("track"));
//        round.getRaces().forEach(race -> RaceController.addLink(race, eventId, round.getId()));
